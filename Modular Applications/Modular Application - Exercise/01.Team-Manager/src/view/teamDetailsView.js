...
export async function teamDetailsView(ctx) {
  ...
  if(isOwner){
    const teamInfo = await getOwnerTeamInfo();
  }
      ...
      <article class="layout">
        ...
        <div class="pad-large">
          ...
          <ul class="tm-members">
            <li>My Username</li>
            <li>
              James${isOwner ? html` <a href="#" class="tm-control action">Remove from team</a>` : ''}
            </li>
            <li>
              Meowth${isOwner ? html` <a href="#" class="tm-control action">Remove from team</a>` : ''}
            </li>
          </ul>
        </div>
        <div class="pad-large">
